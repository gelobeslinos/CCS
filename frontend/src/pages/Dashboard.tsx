...
import { faUsers, faUserGraduate, faCalendarCheck, faFileAlt, faPlus, faCheckCircle, faClock, faChartLine, faCog } from "@fortawesome/free-solid-svg-icons";
        ...
        <>
          ...
          <div style={{ 
            ...
            <div style={{
              ...
              <div style={{ fontSize: '14px', color: '#6c757d' }}>
                <FontAwesomeIcon icon={faUserGraduate} /> Enrolled Students
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '14px', color: '#6c757d' }}>
                <FontAwesomeIcon icon={faCalendarCheck} /> Present Today
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: '14px', color: '#6c757d' }}>
                <FontAwesomeIcon icon={faFileAlt} /> Leave Requests
              </div>
            </div>
          </div>
