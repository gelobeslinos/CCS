...
const FacultyLeaveRequests: React.FC = () => {
    ...
    return (
      <div style={{
        ...
        <div style={{ textAlign: 'center' }}>
          ...
          <p style={{ marginTop: '20px', color: '#6c757d' }}>Loading leave requests...</p>
        </div>
      </div>
    );
  }
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{
                ...
                Your leave requests and approvals will be displayed here.
              </p>
            </div>
          </div>
        </div>
